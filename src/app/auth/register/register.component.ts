...
import {BoardMember, User} from '../../app.interface';
...
export class RegisterComponent implements OnInit {
    ...
    public doRegister(): void {
        ...
        if (this.registerForm.valid) {
            if (this.isParamsEmpty) {
                this.regSubscription$ = this.retroService.registerNewUser(this.registerForm.value).subscribe((res) => {
                    // console.log(res);
                    this.isSubmitted = false;
                }, (error) => {
                    console.log('Confirm Registration is Failed;');
                    this.isSubmitted = false;
                });
            } else {
                let user = {} as User;
                ...
                this.regSubscription$ = this.retroService.completeUserRegistration(this.registerForm.value).subscribe((res) => {
                    // console.log(res);
                    this.isSubmitted = false;
                }, (error) => {
